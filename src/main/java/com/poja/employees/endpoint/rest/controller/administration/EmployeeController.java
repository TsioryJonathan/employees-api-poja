...
public class EmployeeController {
  ...
  @GetMapping("/{id}")
  public ResponseEntity<IndividualResponseWrapper<EmployeeResponse>> getEmployeeById(
  ...
  @PostMapping
  public ResponseEntity<IndividualResponseWrapper<EmployeeResponse>> createEmployee(
  ...
  /* Edit an employee */
  @PutMapping("/{id}")
  public ResponseEntity<IndividualResponseWrapper<EmployeeResponse>> updateEmployee(
